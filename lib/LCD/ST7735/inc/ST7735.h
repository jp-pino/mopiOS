...
// Logical displays definitions
#define ST7735_DISPLAY_TOP 0
#define ST7735_DISPLAY_BOTTOM 1
...
//        from the top edge w     horizontal width of the rectangle h
//        vertical height of the rectangle color 16-bit color, which can be
//        produced by ST7735_Color565()
// Output: none
...
//        from the top edge image pointer to a 16-bit color BMP image w
//        number of pixels wide h     number of pixels tall
// Output: none
...
//------------ST7735_Message------------
// String draw function.
// Output a string in selecting either of two logical displays.
// Position determined by selected screen and line number.
// Top display includes rows 0 to 7.
// Bottom display includes rows 8 to 15.
// Input: device    top or bottom display.
//                  Use: ST7735_DISPLAY_BOTTOM for bottom display
//                  Use: ST7735_DISPLAY_TOP for top display
...
void ST7735_MessageLong(int device, int line, char *string, long value);
